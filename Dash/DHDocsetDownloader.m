...
{    
    [super setUp];
    NSMutableArray *dashFeeds = [NSMutableArray arrayWithObjects:[DHFeed feedWithFeed:@"NET_Framework.xml" icon:@"net"
                                                                         aliases:@[@"Microsoft .NET Framework", @"C#", @"f#", @"vb", @"visual basic", @"visualbasic", @"vstudio", @"visual studio", @"msdn", @"Microsoft Developer Network"]
                                                                  doesNotHaveVersions:NO],
